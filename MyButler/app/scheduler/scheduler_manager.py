...
from app.scheduler.jobs.recording_job import run_daily_recording
...
class SchedulerManager:
    ...
    def _add_recording_job(self):
        ...
        logger.info(f"일일 기록 작업 등록: 평일 {hour:02d}:{minute:02d} KST (DST={is_dst_in_us()})")
    ...
    def _log_next_run_times(self):
        ...
        if recording_job:
            logger.info(f"다음 기록 작업 예정: {recording_job.next_run_time}")
